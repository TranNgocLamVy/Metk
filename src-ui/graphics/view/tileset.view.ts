...
import { TilesetGridRenderer } from "../renderer/tileset-grid.renderer";
import { TilesetRenderer } from "../renderer/tileset.renderer";
import { TilesetSelectorRenderer } from "../renderer/tileset-selector.renderer";
...
export class TilesetView implements IBaseView {
    ...
    private initView(pixiApp: Application) {
        ...
        this.selector = new TilesetSelectorRenderer({ tileset: this.session.tileset, tilesetSession: this.session, parent: this.viewport, gap: this.grid.gridGap });
