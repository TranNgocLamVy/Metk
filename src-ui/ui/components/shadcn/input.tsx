...
function Input({ className: customClassName, type, ...props }: React.ComponentProps<"input">) {
    ...
    const className = "border-foreground/30 h-8 rounded-none border bg-surface-sunken px-2.5 py-1 text-xs transition-colors md:text-xs w-full min-w-0 outline-none";
