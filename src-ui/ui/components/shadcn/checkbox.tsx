...
function Checkbox({ className: customClassName, ...props }: React.ComponentProps<typeof CheckboxPrimitive.Root>) {
    ...
    const className = "flex size-4 items-center justify-center rounded-none border border-foreground/40 bg-surface-sunken transition-colors peer relative shrink-0 outline-none";
    return (
