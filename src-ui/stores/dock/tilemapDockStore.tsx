import { DockviewApi, IDockviewPanelHeaderProps } from "dockview";
import { create } from "zustand";

import { BasePanel } from "@/components/panel/basePanel";
import { DefaultTilemapTabHeader } from "@/components/tab/tilemapTabHeader";

export const tilemapTabComponents = {
	default: DefaultTilemapTabHeader,
};

type TilemapDockStoreState = {
...
export const useTilemapDockStore = create<TilemapDockStoreState>((set, get) => {
	return {
		api: null,
		panels: [],
		currentPanelId: null,
