import { ChevronRightIcon, CircleIcon, Square, SquareCheckBig } from "lucide-react";
import * as React from "react";

import { cn } from "@/view/components/shadcn/utils/shadcn-utils";
...
function DropdownMenuCheckboxItem({ className, children, checked, ...props }: React.ComponentProps<typeof DropdownMenuPrimitive.CheckboxItem>) {
    if (!checked) {
		...
		<DropdownMenuPrimitive.CheckboxItem
			...
			<span className="pointer-events-none absolute left-2 flex size-3.5 items-center justify-center">
				<DropdownMenuPrimitive.ItemIndicator><Square className="size-4 stroke-[1.5]" /></DropdownMenuPrimitive.ItemIndicator>
			</span>
			{children}
		</DropdownMenuPrimitive.CheckboxItem>
	);
	...
	return (
		<DropdownMenuPrimitive.CheckboxItem
			...
			{...props}>
			<span className="pointer-events-none absolute left-2 flex size-3.5 items-center justify-center">
				<DropdownMenuPrimitive.ItemIndicator><SquareCheckBig className="size-4 stroke-[1.5]" /></DropdownMenuPrimitive.ItemIndicator>
			</span>
			{children}
		</DropdownMenuPrimitive.CheckboxItem>
	);
